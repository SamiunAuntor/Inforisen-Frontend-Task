...
export function GoogleReviewBadge() {
  return (
    <div className="flex h-20 w-[194px] items-center gap-3 rounded-2xl bg-white px-[18px] shadow-[0_6px_14px_rgba(30,20,15,0.2)]">
      <Image
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1 whitespace-nowrap text-[15px] font-medium leading-none tracking-[-0.01em] text-[#111]">
